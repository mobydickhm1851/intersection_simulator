...
#################################################################################
            ...
            TTA_area = 3.5
            safe_margin = car_vel[0][1]*TTA_area # TTA_area is the average TTA of the region; safe_margin is to mimic human's decision concerning TTC   
            lh_dist = 0.5 * car_vel[0][1]**2 / brake + safe_margin   # look ahead distance: able to stop with full break
