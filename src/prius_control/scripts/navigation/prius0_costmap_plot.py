...
# initialize the map
map_res = rospy.get_param('/prius0_costmap_plot/cmap_res', 0.1) # default is 1.0
map_size = rospy.get_param('/prius0_costmap_plot/cmap_size', 45) # default is 45
...
if __name__ == '__main__':
    ...
    robot_ns = rospy.get_param('/prius0_costmap_plot/robot_ns') 
