...
def animate_plot(i):
    ...
    if car_dirs[0][0]:   # [1,0] if car0 moving in x-dir
        line1, = ax1.plot(car0_t, car0_vel, light_blue, label='car0_x_velocity')
        line2, = ax1.plot(car1_t, car1_vel, light_orange, label='car1_y_velocity')
    else:   # [0,1] or [0,0] if car0 moving in y-dir or not moving
        line1, = ax1.plot(car0_t, car0_vel, light_blue, label='car0_y_velocity')
        line2, = ax1.plot(car1_t, car1_vel, light_orange, label='car1_x_velocity')
    ...
    plt.title("POS and Velocity Profile in Simulation")
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1 and sys.argv[1] == 'save':
        ani.save('/home/liuyc/moby_folder/Research/figures/intersection_simulator/gif/nonothing.gif', writer='imagemagick', fps=4)
